...
[![pupa-backend](https://img.shields.io/badge/backend-0.0.86-3776ab?logo=python&logoColor=white)](backend/pyproject.toml)
...
|---|---|---|
| **Backend** (Python · FastAPI · Claude Code + deepagents/LangGraph harnesses) | `0.0.86` | [`backend/pyproject.toml`](backend/pyproject.toml) |
